...
```{r}
#| label: q1
# divide each element in the vector by the smallest element and round the results to the nearest whole number.
nums <- 3:12
round(nums/min(nums))
```
